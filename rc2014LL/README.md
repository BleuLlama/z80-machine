...
This is Scott's updated 64k version of the RC2014.  Its features are:
 ...
 - Serial-based mass storage solution via "filter" in the emulation, or
   via interposer relay in the serial line.
...
bit in the Digital IO output.  For the sake of emulation, until
hardware is implemented, this port will be at port address $00.
